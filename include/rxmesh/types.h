...
/**
 * @brief Convert a dynamic operation to string
 * @param op a dynamic operation
 * @return name of the query operation as a string
 */
static std::string op_to_string(const DynOp& op)
{
    switch (op) {
        case DynOp::EdgeFlip:
            return "EdgeFlip";
        case DynOp::DeleteVertex:
            return "DeleteVertex";
        case DynOp::DeleteEdge:
            return "DeleteEdge";
        case DynOp::DeleteFace:
            return "DeleteFace";
        case DynOp::EdgeCollapse:
            return "EdgeCollapse";
        case DynOp::EdgeSplit:
            return "EdgeSplit";
        case DynOp::VertexSplit:
            return "VertexSplit";
        case DynOp::FaceCollapse:
            return "FaceCollapse";
        case DynOp::FaceSplit:
            return "FaceSplit";
        default:
            RXMESH_ERROR("to_string() unknown input dynamic operation");
            return "";
    }
}
}  // namespace rxmesh