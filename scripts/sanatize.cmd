...
call compute-sanitizer  --log-file sanitize_initcheck.log --tool initcheck --track-unused-memory yes ..\build\bin\Debug\RXMesh_test.exe --gtest_filter=RXMeshDynamic.Cavity
