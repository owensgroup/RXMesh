...
class SceneConfigParser
{
   ...
   private:
    ...
    static void parse_simulation_param(const std::string&   key,
                                       std::istringstream&  iss,
                                       SimulationConfig<T>& sim)
    {
        if (key == "time_step")
            iss >> sim.time_step;
        else if (key == "friction_coef")
            iss >> sim.fricition_coef;
        else if (key == "stiffness_coef")
            iss >> sim.stiffness_coef;
        else if (key == "tol")
            iss >> sim.tol;
        else if (key == "dhat")
            iss >> sim.dhat;
        ...
        } else if (key == "ground_x")
            iss >> sim.ground_x;
        else if (key == "ground_y")
            iss >> sim.ground_y;
        else if (key == "ground_z")
            iss >> sim.ground_z;
        else if (key == "ground_nx")
            iss >> sim.ground_nx;
        else if (key == "ground_ny")
            iss >> sim.ground_ny;
        else if (key == "ground_nz")
            iss >> sim.ground_nz;
        else if (key == "use_box")
            iss >> sim.use_box;
        else if (key == "box_min_x")
            iss >> sim.box_min_x;
        else if (key == "box_max_x")
            iss >> sim.box_max_x;
        else if (key == "box_min_y")
            iss >> sim.box_min_y;
        else if (key == "box_min_z")
            iss >> sim.box_min_z;
        else if (key == "box_max_z")
            iss >> sim.box_max_z;
    }

    static void parse_mesh_param(const std::string&  key,
                                 std::istringstream& iss,
                                 MeshConfig<T>&      mesh)
    {
        if (key == "filepath") {
            ...
            iss >> mesh.density;
        else if (key == "young_mod")
            iss >> mesh.young_mod;
        else if (key == "poisson_ratio")
            iss >> mesh.poisson_ratio;
        else if (key == "bending_stiff")
            iss >> mesh.bending_stiff;
        else if (key == "num_instances_x")
            iss >> mesh.num_instances_x;
        else if (key == "num_instances_y")
            iss >> mesh.num_instances_y;
        else if (key == "num_instances_z")
            iss >> mesh.num_instances_z;
        else if (key == "spacing_x")
            iss >> mesh.spacing_x;
        else if (key == "spacing_y")
            iss >> mesh.spacing_y;
        else if (key == "spacing_z")
            iss >> mesh.spacing_z;
            ...
            std::string val;
            iss >> val;
            mesh.fixed_x = (val == "true" || val == "1");
        } else if (key == "fixed_y") {
            std::string val;
            iss >> val;
            mesh.fixed_y = (val == "true" || val == "1");
        } else if (key == "fixed_z") {
            std::string val;
            iss >> val;
            mesh.fixed_z = (val == "true" || val == "1");
        }
    }
};
