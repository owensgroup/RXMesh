...
This repository provides 1) source code to reproduce the results presented in the paper (git tag `v0.1.0` TODO) and 2) ongoing development of RXMesh. For 1), all input models used in the paper can be found under [TODO]().
