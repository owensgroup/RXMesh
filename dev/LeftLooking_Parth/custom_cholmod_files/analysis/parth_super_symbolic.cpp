...
)
{
    ...
    // NOTE: FOR NOW FOCUS ON DIM = 1 -> FOR HIGHER DIM
    // WE NEED MULTIPLICATION
    // TODO: I don't remember why, but I need to double check
    // That why postOrder is fine with this way of grouping.
    std::vector<int> col_to_region(n, 0);
    assert(!parth.hmd.HMD_tree.empty());
