...
#define REAL
#include "t_cholmod_super_solve.h"
#define COMPLEX
#include "t_cholmod_super_solve.h"
...
int ParthSolver::cholmod_super_lsolve_custom /* TRUE if OK, FALSE if BLAS
                                                overflow occured */
    (
        /* ---- input ---- */
  ...
  case CHOLMOD_REAL:
    r_cholmod_super_lsolve_custom(L, X, E, Common, *this);
    break;

  case CHOLMOD_COMPLEX:
    c_cholmod_super_lsolve_custom(L, X, E, Common, *this);
    break;
  }
...
int ParthSolver::cholmod_super_ltsolve_custom /* TRUE if OK, FALSE if BLAS
                                               * overflow occured
                                               */
    (
        /* ---- input ---- */
  ...
  case CHOLMOD_REAL:
    r_cholmod_super_ltsolve_custom(L, X, E, Common, *this);
    break;

  case CHOLMOD_COMPLEX:
    c_cholmod_super_ltsolve_custom(L, X, E, Common, *this);
    break;
  }
